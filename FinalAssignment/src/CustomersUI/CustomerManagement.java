...
public class CustomerManagement implements ActionListener,MouseListener {
	...
	public CustomerManagement() {
		...
		JLabel titlelbl = new JLabel("Customer Management", JLabel.CENTER);
		titlelbl.setFont(new Font("Times New Roman", Font.BOLD, 35));
		titlelbl.setBounds(700, 20, 500, 30);
