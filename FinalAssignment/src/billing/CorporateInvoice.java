...
public class CorporateInvoice {
	...
	public CorporateInvoice() {
		...
		bookingtxtlbl.setText(Integer.toString(Global.currentBilling2.getBooking_ID()));
		...
		statuslbl.setText(Global.currentBilling2.getBilling_Status());
		...
		custnamelbl.setText(Global.currentBilling2.getName());
		...
		roomamount.setText(Integer.toString(Global.currentBilling2.getRoom_Price()));
		...
		drinksamount.setText(Integer.toString(Global.currentBilling2.getBar_Price()));
		...
		foodamount.setText(Integer.toString(Global.currentBilling2.getRestaurant_Price()));
		...
		serviceamount.setText(Integer.toString(Global.currentBilling2.getService_Price()));
		...
		totalbilllbl.setText(Double.toString(Global.currentBilling2.getTotal_Bill()));
