...
public class BillingGUI implements MouseListener {
	...
	public BillingGUI() {
		...
		// Title Label
		JLabel customer = new JLabel("BILLING SYSTEM", SwingConstants.CENTER);
		customer.setBounds(500, 30, 300, 35);
		...
		totalbilllbl.setBounds(380, 220, 210, 35);
		...
		totalbilltxt.setBounds(550, 220, 210, 35);
		...
		billingststaus.setBounds(780, 20, 210, 35);
		...
		billingstatustxt.setBounds(950, 20, 210, 35);
